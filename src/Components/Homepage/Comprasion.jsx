...
const Comprasion = () => {
    return (
        <div className="mb-72 md:mb-32 lg:mb-28 mt-16 px-4 max-w-[1250px] container mx-auto">
            <h2 className="text-3xl font-bold text-black text-center lg:text-left">Make a Comparison</h2>
            <div className="mt-8 flex gap-4">
                {/* 1st card */}
                <div
                    className="hero bg-[url('/assets/images/comprasion/comprasion-1.jpg')] h-[400px] max-w-[573px] bg-cover bg-center rounded-lg relative"
                >
