    ...
    return (
        <div className="hero bg-[url('/assets/images/main-banner/banner1.jpg')] h-[820px] relative">
            ...
            <div className="hero-content text-neutral-content text-center -mt-96">
                <div className="max-w-md">
                    <h1 className="mb-7 text-5xl font-bold text-black">Why Choose Us?</h1>
                        ...
                        <button className="ml-11 text-xl btn btn-primary w-[250px] h-[18px] flex justify-center items-center gap-4 border border-solid rounded-[6px]">
                            Explore More
                        </button>
            ...
            <div className="absolute bottom-[340px] lg:bottom-[159px] w-full text-center">
                <h6 className="text-7xl text-[#F9F9F9]">Exclusive Hotel Search!</h6>
            </div>

            {/* Buttons */}
            <div className="absolute bottom-0 left-0  flex flex-wrap justify-center lg:justify-start lg:gap-1 lg:absolute lg:left-[335px] lg:bottom-0">
                {buttons.map((btn) => (
                    <button
                        key={btn.id}
                        onClick={() => setActiveBtn(btn.id)}
                        className={`w-[240px] h-[48px] font-bold border border-[#07689F] m-2 lg:m-0 ${
                            activeBtn === btn.id
