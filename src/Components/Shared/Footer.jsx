            ...
            <div className='container mx-auto max-w-[1570]'>
                <div className='lg:flex justify-between ml-5 lg:ml-0 '>
                    ...
                    <div className='flex-none md:flex gap-3'>
                        <Image className='h-[48px] mb-3 md:mb-0' alt='pic1' height={20} width={89} src={'/assets/images/footer/Visa Card.png'} />
                        <Image className='h-[48px] mb-3 md:mb-0' alt='pic2' height={20} width={89} src={'/assets/images/footer/Amex.png'} />
                        <Image className='h-[48px] mb-3 md:mb-0' alt='pic3' height={20} width={89} src={'/assets/images/footer/Master Card.png'} />
                    ...
                    {/* input */}
                    <div className='flex pb-0 lg:pb-8 mt-[25px] lg:mt-0 mb-4 lg:mb-0'>
                        <div>
