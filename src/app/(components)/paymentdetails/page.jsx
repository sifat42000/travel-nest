...
const page = () => {
    ...
    return (
        <div className='container md:w-full  lg:flex gap-24 mx-auto mb-20'>
            {/* left side */}
            <div className='sm:ml-[91px] md:ml-[180px] lg:ml-0 pl-2 lg:pl-0'>
                {/* first part */}
                <div className='flex gap-7  bg-[#FFFFFF] w-[470px] lg:w-[519px] h-[780px] lg:h-[680px]'>
                    {/* images */}
                    <div className='p-5'>
                    ...
                    <div className='p-5'>
                        ...
                        <div className='flex gap-12'>
                            ...
                            <p className='text-[#07689F] font-bold'>9,2</p>
                        </div>
                        ...
                        <p className='text-xl mb-4 flex gap-2'><BsCupHot className='mt-1' /> Breakfast Included</p>
                        <p className='text-xl mb-4 flex gap-2'><IoIosWifi className='mt-1' />
                            Free WI-FI</p>
                        <p className='text-xl mb-4 flex gap-2'><LuCircleParking className='mt-1' />
                            Free Parking</p>
                        <p className='text-xl mb-4 flex gap-2'><FaCat className='mt-1' />
                            Pets are Welcome</p>
                        <p className='text-xl mb-4 flex gap-2'><IoShirtOutline className='mt-1' />
                            free laundry service </p>
                        <p className='text-xl mb-4 flex gap-2'><IoLogoNoSmoking className='mt-1' />
                            no smoking</p>
                        <p className='text-xl flex gap-2'><IoIosWoman className='mt-1' />
                ...
                {/* second part */}
                <div className='mt-10 bg-[#FFFFFF] w-[470px] lg:w-[526px] h-[370]'>
                    <div className='p-7'>
                        <p className='text-[#000000] text-xl font-bold '>Your Booking Deteiels</p>
                        <div className='flex gap-9 mt-12 mb-12'>
                            <div>
                ...
                {/* third part */}
                <div className='mt-9 mb-9 bg-[#FFFFFF] w-[470px] lg:w-[526px] h-[320px]'>
                    <div className='p-4'>
                        ...
                        <p className='flex gap-3 mb-8'><PiShoppingCartLight className='mt-[5px]' />
                            cleanliness rooms Rate    <span className='text-[#07689F] font-bold'>8,9</span></p>
                        <div >
                            ...
                            <div className='flex gap-1'>
                                ...
                                <div className='h-[40px] w-[190px] bg-green-100 '>
                            ...
                            <div className='flex gap-1 mt-2'>
                                <div className='h-[40px] w-[240px] bg-green-100 '>
                ...
                {/* fouth part */}
                <div className='mb-12 bg-[#FFFFFF] w-[470px] lg:w-[526px] h-[660px]'>
                    <div className='p-4'>
                        ...
                        <hr className='mt-3 font-bold h-5'></hr>

                        <p className='mt-3 mb-3 text-[#000000] font-bold text-xl'>Cancellation Policy </p>
                        <p className='text-[#000000] mb-4 font-bold'>Free Cancellation</p>
                ...
                {/* fivth part */}
                <div className='mb-16 bg-[#FFFFFF] w-[470px] lg:w-[526px] h-[145px]'>
                    <div className='p-5'>
            ...
            <div  className='sm:ml-[91px] md:ml-[180px] lg:ml-0 pl-2 lg:pl-0'>
                {/* first part */}
                <div className=' bg-[#FFFFFF] w-[470px] lg:w-[660px] h-[420px] lg:h-[350px] mb-6'>
                    <div className='p-6'>
                        <div className='lg:flex gap-24 mb-9'>
                            ...
                            <div className='border border-[#07689F] h-[48px] w-[280px]'>
                                <p className='text-xl text-center mt-2 text-[#07689F]'>Check Your Booking History</p>
                            </div>

                        </div>
                        <div className='lg:flex gap-4 mb-9'>
                            <p className='text-xl font-bold text-[#000000]'>Who are you booking for?</p>
                            <div className='flex gap-2'>
                                <button className='rounded-full text-xl '> <IoMdRadioButtonOff onClick={() => setButton(!isButton)} className={`${isButton ? "bg-[#07689F]" : "bg-white"} text-[#07689F] border border-3 border-black rounded-full`} /></button>
                                <p>I am the main guest </p>
                            </div>
                            <div className='flex gap-2'>
                                <button className='rounded-full text-xl '> <IoMdRadioButtonOff onClick={() => setIsSecondButton(!isSecondButton)} className={`${isSecondButton ? "bg-[#07689F]" : "bg-white"} text-[#07689F] border border-3 border-black rounded-full`} /></button>
                                <p>Booking is for someone else
                                </p>
                            </div>
                        ...
                        <p className='text-[#07689F] text-xl mt-3 flex lg:ml-[450px] gap-2'><FaPencilAlt className='mt-1' />
                            Edit Profile</p>
                    </div>
                </div>

                {/* second part */}
                <div className='bg-[#FFFFFF] w-[470px] lg:w-[660px] h-[620px] lg:h-[410px] mb-8'>
                    <div className='p-5'>
                        ...
                        <div className='lg:flex gap-3 mb-6'>
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        className="h-[45px] w-[415px] border border-[#565656] pl-[30px]"
                                        placeholder="..................."
                                    />
                                </div>
                            </div>
                ...
                {/* third part */}
                <div className='bg-[#FFFFFF] w-[470px] lg:w-[660px] h-[1500px] lg:h-[1320px] mb-6'>
                    <div className='p-5'>
                        ...
                        <p className='w-[440px] lg:w-[581px] text-xl mb-2'>Flexible flight options from Stockholm to Turkiye from SLK 766/round trip. Fnnish booking </p>
                        <p className='w-[440px] lg:w-[581px] text-xl mb-9'>this stay to get flight recommendations that match your selected dates.</p>
                        ...
                        <p className='w-[440px] lg:w-[581px] text-xl mb-2'>Avoid surprises_ get from the airport to your accommodation without a hitch.  </p>
                        <p className='w-[440px] lg:w-[581px] text-xl mb-16'>we will add taxi options to your booking confirmation.  </p>
                        <p className='text-xl text-[#000000] font-bold mb-9'>Special Requests</p>
                        <p className='mb-3 font-semibold text-[#000000]'>Special requests can not be guaranteed _ but the property will do its best to meet your needs. </p>
                        ...
                        <input className='w-[430px] lg:w-[613px] mb-6 h-[106px] border border-[#A6A6A6]' />
                        <div className='flex gap-5 mb-9'>
                            <input type="checkbox" className="h-[25]  w-[25] mt-[2px] border border-[#333333]" />
                            <p className='text-xl  text-[#000000]'>I would like rooms close to each other</p>
                        </div>
                        <p className='text-2xl font-bold mb-7 text-[#000000]'>Your Arrival Time</p>
                        <p className='flex gap-2 mb-4 text-xl'><CiClock1 className='mt-2' /> your rooms will be ready for check_in between 15:00 and 23:00
                        </p>
                        <p className='flex gap-2 mb-8 text-xl'><FaClockRotateLeft className='mt-2' />
                ...
                {/* fourth part */}
                <div className='w-[470px] lg:w-[660px] h-[550px] lg:h-[275px] bg-[#FFFFFF]'>
                    <div className='p-4'>
                        ...
                        <div className='lg:flex justify-between'>
                            <button className='mt-8 btn btn-outline hover:btn-primary  text-center font-bold w-[277px] h-[48px] border border-[#07689F] text-[#07689F]'>Save in Shortcut
                            </button>
